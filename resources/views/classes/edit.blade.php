...
<head>
    ...
    <title>GES EDU - Modifier une classe</title>
...
<body>
    <header class="header">
        <div class="header-content">
            <div><h1><i class="fas fa-school"></i> Modifier une classe</h1><div class="header-subtitle">Mettez à jour les informations</div></div>
        ...
        <div class="form-card">
            <form action="{{ route('classes.update', $classe) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="niveau" class="form-control" value="{{ old('niveau', $classe->niveau) }}" placeholder="Ex: Primaire, Collège">
                </div>
                <div class="form-group">
                    <label class="form-label">Année Scolaire</label>
                    <input type="text" name="annee_scolaire" class="form-control" value="{{ old('annee_scolaire', $classe->annee_scolaire) }}" placeholder="Ex: 2025-2026">
                </div>
