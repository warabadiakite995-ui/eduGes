{{-- resources/views/eleves/form.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>GES EDU - Formulaire Élève</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-content {
            max-width: 800px; /* Le formulaire est plus étroit */
            margin: 0 auto;
            display: flex;
        ...
        .form-label span { color: #dc2626; } /* Astérisque rouge */
...
<body>
        ...
        <div class="header-content">
            <div>
                <h1>
                    ...
                    {{ isset($eleve) ? 'Modifier l\'élève' : 'Ajouter un élève' }}
                </h1>
                <div class="header-subtitle">
                    {{ isset($eleve) ? 'Mettez à jour les informations' : 'Remplissez les informations ci-dessous' }}
                </div>
            </div>
    ...
    <div class="container">
        <div class="form-card">
            {{-- On utilise le même formulaire pour Create et Edit --}}
            <form action="{{ isset($eleve) ? route('eleves.update', $eleve->id) : route('eleves.store') }}" method="POST">
                @csrf
                {{-- Si on est en mode édition, on ajoute la méthode PUT --}}
                @if(isset($eleve))
                    @method('PUT')
                @endif
                ...
                <div class="form-group">
                    ...
                    {{-- Affichage des erreurs de validation (si le formulaire plante) --}}
                ...
                <div class="form-group">
                    ...
                    <select id="classe_id" name="classe_id" class="form-control" required>
                        ...
                        {{-- Boucle pour afficher toutes les classes disponibles --}}
